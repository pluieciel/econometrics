...
houseregHC=housereg.get_robustcov_results(cov_type='HC0')
print(houseregHC.summary(),'\n'*3)

houseregNW=housereg.get_robustcov_results(cov_type='HAC',maxlags=10)
#print(coeftest(housereg,vcov.=NeweyWest(housereg,lag=10,prewhite=FALSE)))
#haven't find how to get exactly print(coeftest(housereg,vcov.=NeweyWest)) in which default 'prewhite=TRUE'
print(houseregNW.summary(),'\n'*3)
